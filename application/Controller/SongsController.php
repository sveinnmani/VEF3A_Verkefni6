...
class SongsController
{
    ...
    public function addSong()
    {
        ...
        if (isset($_POST["submit_add_song"])) {
            ...
            $Song->addSong($_POST["name"], $_POST["publisher"],  $_POST["year"]);
        }
     ...
     */
    public function deleteSong($book_id)
    {
     ...
     */
    public function editSong($book_id)
    {
    ...
    public function updateSong()
    {
        ...
        if (isset($_POST["submit_update_song"])) {
            ...
            $Song->updateSong($_POST["name"], $_POST["publisher"],  $_POST["year"], $_POST['book_id']);
        }
